 ...
 * General settings
 */
$cressida_defaults['cressida_footer_copyright'] = sprintf(
	__( '&copy; Copyright %1$s by <a href="%2$s">LyraThemes.com</a>. All rights reserved.', 'cressida' ),
 ...
 */
$cressida_defaults['cressida_frontpage_featured_posts_show']    = 1;
...
$cressida_defaults['cressida_slide_sample'][] = esc_url( get_theme_file_uri( '/sample/images/1170x550/1170x550-5.jpg' ) );
...
$cressida_defaults['cressida_archive_sample'][] = esc_url( get_theme_file_uri( '/sample/images/760x1100/760x1100-5.jpg' ) );
$cressida_defaults['cressida_archive_sample'][] = esc_url( get_theme_file_uri( '/sample/images/760x1100/760x1100-6.jpg' ) );
$cressida_defaults['cressida_archive_sample'][] = esc_url( get_theme_file_uri( '/sample/images/760x1100/760x1100-7.jpg' ) );
$cressida_defaults['cressida_archive_sample'][] = esc_url( get_theme_file_uri( '/sample/images/760x1100/760x1100-8.jpg' ) );
$cressida_defaults['cressida_archive_sample'][] = esc_url( get_theme_file_uri( '/sample/images/760x1100/760x1100-9.jpg' ) );